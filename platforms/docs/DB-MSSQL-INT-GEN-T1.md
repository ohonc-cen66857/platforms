...
**ShrnutĂ­:** InteraktivnĂ­ ĂşÄŤet pro Microsoft SQL Server na DatabĂˇze. ProstĹ™edĂ­: GenerickĂ©, Tier: T1.
...
## Metadata
- INI: `I:\GitHub\platforms\platforms\DB-MSSQL-INT-GEN-T1\Policy-DB-MSSQL-INT-GEN-T1.ini`
- XML: `I:\GitHub\platforms\platforms\DB-MSSQL-INT-GEN-T1\Policy-DB-MSSQL-INT-GEN-T1.xml` â€” parsed
...
- PolicyID: DB-MSSQL-INT-GEN-T1
- PolicyName: DB-MSSQL-INT-GEN-T1
- PolicyType: Regular
