...
**ShrnutĂ­:** InteraktivnĂ­ ĂşÄŤet pro KEY na UX. ProstĹ™edĂ­: GenerickĂ©, Tier: T1.
...
- **PovolenĂ© safy (regex):** (?!SH-).*

## Metadata
- INI: `I:\GitHub\platforms\platforms\UX-KEY-INT-GEN-T1\Policy-UX-KEY-INT-GEN-T1.ini`
- XML: `I:\GitHub\platforms\platforms\UX-KEY-INT-GEN-T1\Policy-UX-KEY-INT-GEN-T1.xml` â€” parsed
...
- PolicyID: UX-KEY-INT-GEN-T1
- PolicyName: UX-KEY-INT-GEN-T1
- PolicyType: Regular
