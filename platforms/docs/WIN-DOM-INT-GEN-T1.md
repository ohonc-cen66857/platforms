...
**ShrnutĂ­:** InteraktivnĂ­ ĂşÄŤet pro DomĂ©na na Windows. ProstĹ™edĂ­: GenerickĂ©, Tier: T1.
...
## Metadata
- INI: `I:\GitHub\platforms\platforms\WIN-DOM-INT-GEN-T1\Policy-WIN-DOM-INT-GEN-T1.ini`
- XML: `I:\GitHub\platforms\platforms\WIN-DOM-INT-GEN-T1\Policy-WIN-DOM-INT-GEN-T1.xml` â€” parsed
...
- PolicyID: WIN-DOM-INT-GEN-T1
- PolicyName: WIN-DOM-INT-GEN-T1
- PolicyType: Regular
